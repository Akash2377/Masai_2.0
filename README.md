...
6. A lecture contains the lecture name, lecture description, and lecture video (you can use youtube videos for reference)
7. Make a payment gateway for purchasing the course after purchase user should be able to see the course
9. Profile section where the user can add his basic info and see all the courses that he has enrolled
10. Make a wishlist where the user can add any course to buy it later this can also be seen in the profile section, the user can also delete the course from the profile section
11. Cart page where user can see all the courses added to the cart 
12. An admin can add any number of lectures in a course, also update the previous lecture,s and can also delete a lecture
...
![CwyiHSwvZ](https://cdn.hashnode.com/res/hashnode/image/upload/v1658678763312/k6jZd7eo_.png)
...
## Github link
> ### •[Masai 2.0](https://github.com/Akash2377/Masai_2.0)
